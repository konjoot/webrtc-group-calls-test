...
* легкие (групповой звонок до 5-ти человек)
* тяжелые (групповой звонок более 5-ти человек)

К каждому из них соответствуют разные требования. Если в случае легкого группового звонка можно передавать видео и аудио потоки от каждого из клиентов (возможно даже без использования медиа-сервиса - мульти-p2p звонок, звонящий устанавливает отдельную сессию со всеми участниками), то в случае тяжолого группового звонка нужно передавать только актуальное(-ные) видео отдельными потоками, но аудио по прежнему передавать от всех клиентов при этом сведенное в один медиа-поток. Для тяжелых групповых звонков должны быть реализованы следующие стратегии управления видео-потоками:
...
В целом могу резюмировать, что без медиа-сервиса можно реализовать групповый звонки посредством p2p соединений между браузерами, однако кол-во участников не сможет превышать 10 человек для аудио и 4 человек для видео. Это вкупе с отправкой видео меньшего разрешения и аудио худшего качества (в тестах выше настройки были по-умолчанию - в этом случае браузер сначала пытается оправлять медиа максимально хорошего качества и занимать всю доступную полосу пропускания), а так же с учетом того, что если участник не говорит - он мьютит микрофон.
